...
class KisilerDaoRepository{
  ...
  Future<void> guncelle(String kisi_id , String kisi_ad , String kisi_tel) async{
    var gucellenenKisi = HashMap<String,dynamic>();
    gucellenenKisi["kisi_ad"] = kisi_ad;
    gucellenenKisi["kisi_tel"] = kisi_tel;
    collectionKisiler.doc(kisi_id).update(gucellenenKisi);
  }
